...
namespace zx270.Web
{
    public partial class MerDinpayUTF_8 : BasePage
    {
        protected string actionurl = "http://pay.quankeba.com/Payment.aspx";
        private HKModel HKModel
        {
            get
            {
                ...
                model.RealMoney = model.ValidMoney*BLL.Configuration.Model.B_InFloat;
                model.ToBank = "";
                model.IsAuto = true;
                model.Sign = false;
                return model;
