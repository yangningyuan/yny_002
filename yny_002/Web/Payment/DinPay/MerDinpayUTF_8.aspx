<%@ Page Language="C#" AutoEventWireup="true" Inherits="zx270.Web.MerDinpayUTF_8"
    ResponseEncoding="utf-8" CodeBehind="MerDinpayUTF_8.aspx.cs" %>
...
<body style="text-align: center;">
    <div style="padding-top: 30px; width: 280px; margin: 0 auto;">
        <h1>
            支付处理中...</h1>
        <br />
        <a href="javascript:void(0);" onclick="tijiao()">如没有自动跳转请点击</a>
    </div>
    <form action="<%=actionurl %>" id="dinpayForm" name="dinpayForm" method="post" style="display: none;"
    target="_search">
