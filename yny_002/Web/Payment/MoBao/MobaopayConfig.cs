...
namespace com.mobaopay.merchant
{
    ...
    public class MobaopayConfig
    {
        ...
        static MobaopayConfig()
        {
            ...
            mbp_key = "46533a445b84b0aefdd56a4df314cce2";
            ...
            mobaopay_gateway = "http://pay.nhrcw.com.cn";

            //商户接受支付通知地址(商户自己系统的地址)
            merchant_notify_url = "http://www.fenglee.net/Payment/MoBao/PayResult.aspx";

            //商户平台号及商户帐号
            platform_id = "210001440007179";
            merchant_acc = "210001440007179";
