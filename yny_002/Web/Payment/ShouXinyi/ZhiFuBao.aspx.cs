...
namespace yny_002.Web.Payment.ShouXinyi
{
    public partial class ZhiFuBao : BasePage
    {
        ...
        protected new void Page_Load(object sender, EventArgs e)
        {
            ...
            if (hkModel.RealMoney > 500)
            {
                Response.Write("支付宝单笔充值最高500，可以分多笔支付");
                Response.End();
            }
            ...
            //提交地址
            string form_url = ShouXinYi.directUrl;
            //姓名
            ...
            postForm += "<input type=\"hidden\" name=\"v_pmode\" value=\"271\" />";//支付完成后返回的页面地址
