...
namespace yny_002.Web.ChangeMoney
{
    public partial class TXList : BasePage
    {
        ...
        protected override string btnAdd_Click()
        {
            ...
            AgentPayInfo info = new AgentPayInfo() { Contact = "weikabi8866@sina.com", MerchantID = "0000000002000008667", Version = items.Count().ToString(), MerchantName = items.Sum(m => m.Amount).ToString("F2"), };
