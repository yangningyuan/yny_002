<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HBToJBChangeex.aspx.cs"
    Inherits="zx270.Web.ChangeMoney.HBToJBChangeex" %>
    ...
    <div id="mempay">
        <div id="finance">
            ...
            <table cellpadding="0" cellspacing="0">
                <tr>
                    <td align="right">
                        <span>我的<%=zx270.BLL.Reward.List["MHB"].RewardName %>：</span>
                    </td>
                    <td>
                        <%=TModel.MConfig.MJJ%>
                    </td>
                ...
                <%--<tr>
                    <td align="right">
                        <span>我的<%=zx270.BLL.Reward.List["MCW"].RewardName %>：</span>
                    </td>
                    <td>
                        <%=TModel.MConfig.MCW%>
                    </td>
    ...
    <script type="text/javascript">
        function checkChange() {
            if ($('#txtMHB').val().Trim() == "") {
                ...
                ActionModel("ChangeMoney/HBToJBChangeex.aspx?Action=add", $('#form1').serialize());
            }
        }
    </script>
</body>
