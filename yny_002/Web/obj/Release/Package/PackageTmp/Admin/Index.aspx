<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="qxjSoft.Web.Admin.Index" %>
        ...
        <div class="banner-navigation">
            <div class="banner-nav">
                ...
                <ul class="flexy-menu orange nav1">
                    ...
                    <%
                        foreach (qxjSoft.Model.RolePowers item in GetPowers("0"))
                        {
                    %>
                    <li class="hvr-sweep-to-bottom">
                        ...
                        <ul>
                            <%foreach (qxjSoft.Model.RolePowers item2 in GetPowers(item.CID))
                                {
