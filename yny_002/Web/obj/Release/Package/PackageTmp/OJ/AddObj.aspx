<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddObj.aspx.cs" Inherits="qxjSoft.Web.OJ.AddObj" %>
            ...
            <table cellpadding="0" cellspacing="0">
                <tr>
                    <td width="15%" align="right">
                        经费项目名称<input runat="server" id="lbID" type="hidden" />
                    </td>
    ...
    <script type="text/javascript">
        ...
        function checkChange() {
            if ($('#txtName').val() == '') {
                ...
                ActionModel("OJ/AddObj.aspx?Action=Modify", $('#form1').serialize(), "OJ/ObjList.aspx");
            }
        }
    </script>
</body>
