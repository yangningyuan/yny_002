<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebSet.aspx.cs" Inherits="yny_002.Web.SysManage.WebSet" %>
            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <tr style="height: 50px;">
                    <td colspan="2" align="right">
                        <input name="重置" type="reset" class="normal_btnok" value="重置" runat="server"   onclick="checkChange2();" />
                    </td>
