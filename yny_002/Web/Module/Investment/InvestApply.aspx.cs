...
namespace yny_002.Web.Module.Investment
{
    public partial class InvestApply : BasePage
    {
        ...
        protected override string btnAdd_Click()
        {
            ...
            if (!string.IsNullOrEmpty(Request.Form["txtMHB"]))
            {
                ...
                if (money + TModel.MConfig.SHMoney > BLL.Configuration.Model.E_BbinFHFloat)
                    return "超出会员持有金额，还可投资"+ ((BLL.Configuration.Model.E_BbinFHFloat-TModel.MConfig.SHMoney)<0?0: (BLL.Configuration.Model.E_BbinFHFloat - TModel.MConfig.SHMoney)).ToString();
