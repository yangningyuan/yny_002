...
namespace yny_002.DAL
{
    ...
    public partial class JoggleLogin
    {
        ...
        public yny_002.Model.JoggleLogin GetModel(int ID)
        {
            ...
            yny_002.Model.JoggleLogin model = new yny_002.Model.JoggleLogin();
        ...
        /// 得到一个对象实体
        /// </summary>
        public yny_002.Model.JoggleLogin GetModelByMID(string mid, string time)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 ID,MID,Code,Createtime,isValid from JoggleLogin ");
        ...
        /// 得到一个对象实体
        /// </summary>
        public yny_002.Model.JoggleLogin DataRowToModel(DataRow row)
        {
            yny_002.Model.JoggleLogin model = new yny_002.Model.JoggleLogin();
            if (row != null)
            {
