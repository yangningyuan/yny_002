...
namespace yny_002.DAL
{
    ...
    public partial class QuitRecord
    {
        ...
        public static Hashtable Update(yny_002.Model.QuitRecord model, Hashtable MyHs)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        public yny_002.Model.QuitRecord GetModel(string ID)
        {
            ...
            yny_002.Model.QuitRecord model = new yny_002.Model.QuitRecord();
        ...
        /// 得到一个对象实体
        /// </summary>
        public static yny_002.Model.QuitRecord DataRowToModel(DataRow row)
        {
            yny_002.Model.QuitRecord model = new yny_002.Model.QuitRecord();
            if (row != null)
            {
        ...
        {
            List<yny_002.Model.QuitRecord> list = new List<yny_002.Model.QuitRecord>();
