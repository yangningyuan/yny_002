...
namespace yny_002.BLL
{
    ...
    {
        private readonly yny_002.DAL.JoggleLogin dal = new yny_002.DAL.JoggleLogin();
        public JoggleLogin()
        { }
        #region  BasicMethod
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(yny_002.Model.JoggleLogin model)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(yny_002.Model.JoggleLogin model)
        {
        ...
        /// 得到一个对象实体
        /// </summary>
        public yny_002.Model.JoggleLogin GetModel(int ID)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<yny_002.Model.JoggleLogin> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<yny_002.Model.JoggleLogin> DataTableToList(DataTable dt)
        {
            List<yny_002.Model.JoggleLogin> modelList = new List<yny_002.Model.JoggleLogin>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                yny_002.Model.JoggleLogin model;
