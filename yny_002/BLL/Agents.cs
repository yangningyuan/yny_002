...
namespace yny_002.BLL
{
    ...
    {
        private readonly yny_002.DAL.Agents dal = new yny_002.DAL.Agents();
        public Agents()
        { }
        #region  BasicMethod
        ...
        /// 增加一条数据
        /// </summary>
        public static bool Add(yny_002.Model.Agents model)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(yny_002.Model.Agents model)
        {
        ...
        /// 得到一个对象实体
        /// </summary>
        public static yny_002.Model.Agents GetModel(int ID)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public static List<yny_002.Model.Agents> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public static yny_002.Model.Agents GetModel(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public static List<yny_002.Model.Agents> DataTableToList(DataTable dt)
        {
            List<yny_002.Model.Agents> modelList = new List<yny_002.Model.Agents>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                yny_002.Model.Agents model;
