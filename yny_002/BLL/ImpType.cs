...
namespace yny_002.BLL
{
    ...
    {
        private readonly yny_002.DAL.ImpType dal = new yny_002.DAL.ImpType();
        public ImpType()
        { }
        #region  BasicMethod
        /// <summary>
        ...
        /// 获得数据列表
        /// </summary>
        public static List<yny_002.Model.ImpType> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public static List<yny_002.Model.ImpType> DataTableToList(DataTable dt)
        {
            List<yny_002.Model.ImpType> modelList = new List<yny_002.Model.ImpType>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                yny_002.Model.ImpType model;
