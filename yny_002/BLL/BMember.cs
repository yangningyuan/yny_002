...
namespace yny_002.BLL
{
    public class BMember
    {
        ...
        public static yny_002.Model.BMember GetModel(string obj)
        {
            return yny_002.DAL.BMember.GetModel(obj);
        }
        ...
        public static System.Collections.Hashtable Insert(yny_002.Model.BMember model, System.Collections.Hashtable MyHs)
        {
            DAL.BMember.tempBMemberList.Add(model);
            return yny_002.DAL.BMember.Insert(model, MyHs);
        }

        public static bool Insert(yny_002.Model.BMember model)
        {
            lock (obj)
            {
        ...
        public static System.Collections.Hashtable Update(yny_002.Model.BMember model, System.Collections.Hashtable MyHs)
        {
            return yny_002.DAL.BMember.Update(model, MyHs);
        }

        public static bool Update(yny_002.Model.BMember model)
        {
            return yny_002.DAL.BMember.Update(model);
        }

        public static System.Collections.Hashtable Delete(object obj, System.Collections.Hashtable MyHs)
        {
            return yny_002.DAL.BMember.Delete(obj, MyHs);
        }

        public static bool Delete(object obj)
        {
            return yny_002.DAL.BMember.Delete(obj);
        }

        public static System.Data.DataTable GetTable(string strWhere)
        {
            return yny_002.DAL.BMember.GetTable(strWhere);
        }

        public static System.Data.DataTable GetTable(string strWhere, int pageIndex, int pageSize, out int count)
        {
            return yny_002.DAL.BMember.GetTable(strWhere, pageIndex, pageSize, out count);
        }

        public static List<yny_002.Model.BMember> GetList(string strWhere)
        {
            return yny_002.DAL.BMember.GetList(strWhere);
        }
        public static List<yny_002.Model.BMember> GetList(int top, string strWhere)
        {
            return yny_002.DAL.BMember.GetList(top, strWhere);
        }

        public static List<yny_002.Model.BMember> GetList(string strWhere, int pageIndex, int pageSize, out int count)
        {
            return yny_002.DAL.BMember.GetList(strWhere, pageIndex, pageSize, out count, "BMID DESC");
        }

        public static string GetBMID(Model.Member model)
        {
            return yny_002.DAL.BMember.GetBMID(model);
        }
    }
}
