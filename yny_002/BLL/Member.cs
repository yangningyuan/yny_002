...
namespace yny_002.BLL
{
    public class Member
    {
        ...
        public static Model.Member InsertAndReturnEntity(Model.Member model, int count, bool NeedEmail, ref string retStr)
        {
            ...
            {
                model.MState = false;
                model.RoleCode = BLL.Roles.RolsList["Nomal"].RType;
		...
		/// <param name="MID"></param>
		/// <returns></returns>
		public static Model.Member GetModelByMIDQR(string MID)
		{
			return DAL.Member.GetModelQR(MID);
		}
		/// <summary>
		/// 得到个人信息
		/// </summary>
        ...
        public static string GetTestMID()
        {
            ...
            string mid = "wx" + rand.Next(1000000, 9999999).ToString();
            while (DAL.Member.TestMID(mid))
            {
                mid = "wx" + rand.Next(1000000, 9999999).ToString();
            }
            return mid;
        }
        ...
        /// <returns></returns>
        public bool UpdateConfiguration(yny_002.Model.Configuration ConfigurationModel)
        {
